    ...
    >
      ...
      <div className="grid gap-1.5">
        {payload.map((item, index) => {
          ...
          // Use a stable key: prefer dataKey or name, fall back to value then index
          const stableKey = i && (i.dataKey || i.name) ? i.dataKey || i.name : i && i.value !== undefined ? `value-${i.value}` : `idx-${index}`
