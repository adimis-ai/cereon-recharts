...
import { composeRefs, cn } from "../lib/index";
...
const SortableItem = React.forwardRef<HTMLDivElement, SortableItemProps>(
  ({ value, asTrigger, asChild, className, ...props }, ref) => {
    ...
    // When used with table rows, we want to avoid using transform directly
    // Instead, we'll apply a class that handles the visual transform
    const style: React.CSSProperties = asChild
      ? {
